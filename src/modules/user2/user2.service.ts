...
export class User2Service {
	constructor(
		@InjectRepository(User2Entity)
		private userRepository: Repository<User2Entity>,
	) {}
	...
	findOne(
		findData: FindOptionsWhere<User2Entity>,
	): Promise<User2Entity | null> {
	...
	async createUser(userRegisterDto: UserCreateDto): Promise<User2Entity> {
		const user: User2Entity = this.userRepository.create(userRegisterDto);
		const savedUser: User2Entity = await this.userRepository.save(user);
	...
	async updateUser(
		...
		return await this.userRepository.update(
			id,
			updateEventsDto as User2Entity,
		);
	}
