...
export async function up(
	...
	// 		birthDate: faker.date.birthdate({ mode: "age", min: 18, max: 65 }),
	// 		email: null,
	// 		username: "sasha_operator",
	// 		password: "sasha_operator",
	// 		avatar: "user_default_avatar.png",
	// 		register_status: UserRegisterStatus.FINISHED,
	// 		is_phone_verified: true,
	// 		is_verified: true,
	...
	// 		phone: "70000000070",
	// 		role: RoleType.AGENT,
	// 		firstName: "Саша (agent)",
	// 		lastName: "Шура",
	// 		birthDate: faker.date.birthdate({ mode: "age", min: 18, max: 65 }),
	// 		email: null,
	// 		username: "sasha_agent70",
	// 		password: "sasha_agent70",
	// 		avatar: "user_default_avatar.png",
	// 		register_status: UserRegisterStatus.FINISHED,
	// 		is_phone_verified: true,
	// 		is_verified: true,
...
export async function down(dataSource: DataSource) {
	const tableName = dataSource.getMetadata(UserEntity).tableName;
